...
LicenseFile=F:\src\zc\vorbital\Release\License.txt
OutputDir=F:\src\zc\Vorbital\Release
OutputBaseFilename=VorbitalPlayer3Setup
Compression=lzma
...
[Files]
Source: "F:\src\zc\vorbital\Release\vorbital.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "F:\src\zc\vorbital\Release\alut.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "F:\src\zc\vorbital\Release\msvcp71.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "F:\src\zc\vorbital\Release\msvcr71.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "F:\src\zc\vorbital\Release\wavpackdll.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "F:\src\zc\vorbital\Release\libsndfile-1.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "F:\src\zc\vorbital\Release\vorbital.ico"; DestDir: "{app}"; Flags: ignoreversion
Source: "F:\src\zc\vorbital\Release\add.xpm"; DestDir: "{app}"; Flags: ignoreversion
Source: "F:\src\zc\vorbital\Release\folder.xpm"; DestDir: "{app}"; Flags: ignoreversion
Source: "F:\src\zc\vorbital\Release\forward.xpm"; DestDir: "{app}"; Flags: ignoreversion
Source: "F:\src\zc\vorbital\Release\normal.xpm"; DestDir: "{app}"; Flags: ignoreversion
Source: "F:\src\zc\vorbital\Release\null.xpm"; DestDir: "{app}"; Flags: ignoreversion
Source: "F:\src\zc\vorbital\Release\pause.xpm"; DestDir: "{app}"; Flags: ignoreversion
Source: "F:\src\zc\vorbital\Release\play.xpm"; DestDir: "{app}"; Flags: ignoreversion
Source: "F:\src\zc\vorbital\Release\question.xpm"; DestDir: "{app}"; Flags: ignoreversion
Source: "F:\src\zc\vorbital\Release\random.xpm"; DestDir: "{app}"; Flags: ignoreversion
Source: "F:\src\zc\vorbital\Release\remove.xpm"; DestDir: "{app}"; Flags: ignoreversion
Source: "F:\src\zc\vorbital\Release\reverse.xpm"; DestDir: "{app}"; Flags: ignoreversion
Source: "F:\src\zc\vorbital\Release\stop.xpm"; DestDir: "{app}"; Flags: ignoreversion
; NOTE: Don't use "Flags: ignoreversion" on any shared system files
Source: "F:\src\zc\vorbital\Release\vcredist_x86.exe"; DestDir: "{app}"; Flags: ignoreversion deleteafterinstall
Source: "F:\src\zc\vorbital\Release\oalinst.exe"; DestDir: "{app}"; Flags: ignoreversion deleteafterinstall
 
[Icons]
Name: "{group}\Vorbital"; Filename: "{app}\vorbital.exe"
